...
import 'package:selpar_selcuk_yamann_223301109/sayfalar/teklifimiguncelle.dart';

class TekliflerimiListele extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('Kullaniciadi', isEqualTo: kullaniciEpostasi)
            .snapshots(),
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) =>TeklifGuncelle(ilanId: id)
                                    ),
                                  );
                                },
